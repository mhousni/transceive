    ...
    Route::group(['prefix' => 'user', 'namespace' => 'Frontend\User', 'middleware' => ['auth', 'verified', '2fa.verify']], function () {
        ...
        Route::middleware('isSubscribed')->group(function () {
            ...
            Route::name('user.')->group(function () {
                ...
                // Route::get('workspace', 'WorkspaceController@setStarredFiles')->name('setStarredFiles');
                Route::name('workspace.')->prefix('workspace')->group(function () {
                    Route::get('/', 'WorkspaceController@index')->name('index');
                    Route::post('/setStarredFiles', 'WorkspaceController@setStarredFiles')->name('setStarredFiles');
                    Route::post('/renameFile', 'WorkspaceController@renameFile')->name('renameFile');
                    Route::post('/archiveFile', 'WorkspaceController@archiveFile')->name('archiveFile');
                    Route::post('/archiveFiles', 'WorkspaceController@archiveFiles')->name('archiveFiles');
                    Route::post('/shareFile', 'WorkspaceController@shareFile')->name('shareFile');
                    Route::post('/createFolder', 'WorkspaceController@createFolder')->name('createFolder');
                    Route::post('/moveFileToFolder', 'WorkspaceController@moveFileToFolder')->name('moveFileToFolder');
                });
