@extends('trustlicence::layouts.app')
...
@section('content')
    ...
    <div class="vironeer-requirements">
        ...
        <div class="alert alert-danger">
            ...
            {{ __('If you are going to install the item on local server you need to use ') }} <strong>Localhost</strong>
            {{ __('or your licence will be registred') }}
        </div>
