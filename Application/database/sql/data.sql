...
--
-- Host: localhost
-- Generation Time: Aug 07, 2022 at 12:43 AM
...
CREATE TABLE `plans` (
  ...
  `storage_space` bigint(100) DEFAULT NULL,
  `transfer_size` bigint(100) DEFAULT NULL,
  `transfer_interval` bigint(100) DEFAULT NULL,
...
(61, 'active_users_counter', '0'),
(62, 'transferred_files_counter', '0'),
(63, 'daily_visitors_couner', '0'),
(64, 'all_time_downloads_couner', '0'),
(65, 'counter_status', '0'),
...
CREATE TABLE `transactions` (
  ...
  `details_before_discount` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
ALTER TABLE `translates`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10757;
