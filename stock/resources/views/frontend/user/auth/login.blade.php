                        ...
                        <div class="vr__sign__header">
                            ...
                            <div class="sign-body">
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <p class = "already">Dont have an account yet?&nbsp;&nbsp;<span class="sign-in sign-up-pop">Sign up</span></p>
                    ...
                    <div class="vr__sign__form vr__register register_mh">
                        ...
                        <div class="sign-body">
                            <form action="{{ route('register') }}" method="POST">
                                ...
                                <p class = "already">Alreay have an account?&nbsp;&nbsp;<span class="sign-in sign-in-pop">Login</span></p>
                                {!! facebook_login() !!}
                            </form>
                        </div>
                     </div>
