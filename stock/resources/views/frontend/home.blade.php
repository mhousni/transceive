                    ...
                    <div class="dropzone-uploadbox  show-forms">
                        <div class="dropzone-uploadbox-upper">
                            <div class="dropzone-uploadbox-header d-flex flex-column">
                                <div class="dropzone-more d-flex justify-content-between w-100 " data-dz-click>
                                    
                                    <div class="ms-0">
                                        <h2 class=" dropzone-more-title text-white display-4">{{ lang('Add More', 'upload zone') }}</h2>
                                        <p class="text-white text-decoration-underline fw-normal ">{{ lang('Or select a folder', 'upload zone') }}</p>
                                ...
                                <div class="increase d-flex w-100 gap-5">
                                    <span class="text-white bold">{{ lang('Up to 10 GB free', 'upload zone') }}</span>
                                    <a href="#" class="" style="color: #A810EA"> 
                                        <svg width="13" height="15" viewBox="0 0 13 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7.85328 0.190881V5.59608H12.4375L5.80805 14.9453V8.64568H0.56975L7.85328 0.190881Z" fill="#A810EA"/>
                                        </svg>
                        ...
                        <div class="dropzone-uploadbox-lower">
                            <div class="dropzone-form-actions  ">
                                @if (subscription()->plan->transfer_link)
                                    <div class="text-white dropzone-form-action drop-active selected">
                                        <i class="fa fa-link"></i>
                                        {{ lang('Link', 'upload zone') }}
                                    </div>
                                @endif
                                <div class="text-white dropzone-form-action">
                                    <i class="fa fa-envelope"></i>
                                    {{ lang('Email', 'upload zone') }}
                                </div>
                            </div>
                                    ...
                                    {{-- MH START --}}
                                        ...
                                        <div class="drop-down dropzone-form-edit" data-dropdown
                                            ...
                                            <div class="drop-down-btn">
                                                ...
                                                <i class="fa-solid fa-ellipsis fa-2x text-white bg-secondary p-3" style="border-radius: 50%;
                                                background-color: #eff0f24f !important;"></i>
                                            </div>
                                            <div class="drop-down-menu">
                                                @if (subscription()->plan->transfer_password)
